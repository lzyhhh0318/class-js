...
class Database {
    constructor() {
        ...
        Object.defineProperty(this, "assignments", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Map()
        ...
        Object.defineProperty(this, "accessLogs", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: []
    ...
    seed() {
        const teacher1 = { id: 'teacher-1', name: '张教授', role: 'teacher', courseIds: ['course-1', 'course-2'] };
        const teacher2 = { id: 'teacher-2', name: '李教授', role: 'teacher', courseIds: ['course-3'] };
        const student1 = { id: 'student-1', name: '王同学', role: 'student', courseIds: ['course-1', 'course-2'] };
        const student2 = { id: 'student-2', name: '赵同学', role: 'student', courseIds: ['course-1', 'course-3'] };
        const student3 = { id: 'student-3', name: '刘同学', role: 'student', courseIds: ['course-1'] };
        const student4 = { id: 'student-4', name: '陈同学', role: 'student', courseIds: ['course-1'] };
        const admin1 = { id: 'admin-1', name: '系统管理员', role: 'admin', courseIds: [] };
